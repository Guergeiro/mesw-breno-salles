...
latency. It was created in 2009 by Salvatore Sanfilippo \citeWEB{redis-creator}
based on the idea that a cache can also be a durable data store. Around this
time, applications like Instagram \citeWEB{redis-popular} were growing
exponentially and needed a way to deliver data to their end users faster than a
relation database could handle.

Redis, which means Remote Dictionary Server \citeWEB{redis-meaning}, was adopted
...
\citeWEB{redis-data-types}. It can be used as a distributed key-value store,
cache, and message broker \citeWEB{redis-usage}. This latter use case is exactly
