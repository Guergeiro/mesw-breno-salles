...
By using some keywords mentioned in \Cref{tab:keywords} the following initial
...
To increase the number of works found, we changed the focus to be on the
...
Relying on the keywords identified in \Cref{tab:keywords}, the following query
was created:
