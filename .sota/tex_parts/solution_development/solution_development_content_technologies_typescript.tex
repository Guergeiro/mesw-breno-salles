TypeScript, an open-source language developed and maintained by Microsoft, is considered a superset of JavaScript that introduces static typing to the language.
